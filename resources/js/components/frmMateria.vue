...
<center>
    ...
    <form action="" method="$POST">
        <table>
                <tr>
                    <td>Nombre</td>
                    <td><input type="text" v-model="nombre" placeholder="Nombre materia"></td>
                </tr>
        ...
        <br>
        <br>
        <input type="text" v-model="buscar" placeholder="Nombre materia">
    ...
    <table border="1">
        ...
        <tbody>
            <tr v-for="materia in arrayMateria" :key="materia.id">
                ...
                <td><a href="#" @click="llenar(materia)">Seleccionar</a></td>
            </tr>
        </tbody>
    </table>
    </div>
