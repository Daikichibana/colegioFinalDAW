        ...
        <table border="1">
          ...
          <tbody v-if="arrayDetalle.length">
            <tr v-for="(detalle, index) in arrayDetalle" :key="detalle.id">
              ...
              <td v-text="detalle.apoderadoApellido"></td>
          ...
          <tr v-for="inscripcion in arrayInscripcion" :key="inscripcion.id">
            ...
            <td
              v-text="
                ...
                ' ' +
                inscripcion.estudianteApellido
              "
            ></td>
            <td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <center>
              ...
              <input
                type="text"
                v-model="estudianteApellido2"
                placeholder="Apellido"
              />
              <button
                type="button"
                @click="listarNota(buscarNota, estudianteApellido2)"
              >
                Buscar por Nombre</button
              ><br />
    ...
    seleccionarApoderado(data = []) {
      ...
      if (me.encuentra(data["id"])) {
        ...
        me.arrayDetalle.push({
          ...
          apoderadoApellido: data["apellido"],
